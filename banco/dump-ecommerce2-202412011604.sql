...
INSERT INTO `auditoria` VALUES (1,4,719.99,699.99,'Alteração de preços','2024-12-01');
...
INSERT INTO `categoria` VALUES (1,'string'),(2,'Processadores'),(3,'Memória RAM'),(4,'Armazenamento'),(5,'Fontes'),(6,'Gabinetes'),(7,'Placas Mãe'),(8,'Coolers'),(9,'Kit Upgrade'),(10,'teste');
...
INSERT INTO `cliente` VALUES (1,'string','string','2024-11-27','string',0,NULL),(2,'sdfsdfsdf','234234234',NULL,'sdfsdf',23423423,NULL),(3,'patrick','00000000',NULL,'string',0,NULL);
...
INSERT INTO `pedido` VALUES (1,2,'2024-11-27',900.00),(2,2,'2024-11-27',4141.00),(3,2,'2024-11-27',1234.00),(4,2,'2024-11-27',1234.00),(5,1,'2024-11-28',5000.00);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_audit_preco_produto
AFTER UPDATE ON produto -- Corrigido o uso de ON
FOR EACH ROW
BEGIN
    -- Verifica se o preço foi alterado
    IF OLD.preco <> NEW.preco THEN
        INSERT INTO auditoria (id_produto, valor_atual, valor_novo, motivo, data_mod)
        VALUES
        (NEW.id_produto, OLD.preco, NEW.preco, 'Alteração de preços', NOW());
    END IF;
END */;;
DELIMITER ;
...
-- Dump completed on 2024-12-01 16:04:58
